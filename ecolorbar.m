...
%
% Built on Tore Furevik's MY_COLORBAR. 
%
...
%Time-stamp:<Last updated on 13/09/03 at 09:14:13 by even@nersc.no>
%File:</Users/even/matlab/evenmat/ecolorbar.m>
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% What D is input...
if isvec(D)     % D is a vector and therefore a contourspecification
  V=D;
...
switch L
case 't'  
 W=W*a(4); % from relative to absolute
 % placement of the colorbar:
 if findstr(get(h0,'XAxisLocation'),'top'),os=1*W; else os=2*W; end 
 if outside
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
case 'r'  %default
 W=W*a(3);  % from relative to absolute
 % placement of the colorbar:
...
set(h1,'tag','ecolorbar','layer','top','ticklength',[0.002 0],'box','on');
% Patch styling:

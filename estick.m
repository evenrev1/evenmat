...
% though. All modifications are put between % ---- or marked "%%% e".
%                                                       Even
%
%Time-stamp:<Last updated on 06/01/04 at 17:37:59 by even@nersc.no>
%File:</home/even/matlab/evenmat/estick.m>
...
% ---------------------------
axis equal %%% e
set(gca,'ytick',yp(1),'ygrid','on','yticklabel','')
% ---------------------------
